...
data_path <- "~/Projects/AIM/Data/AIM_Terrestrial_Pub_4-8-26.gdb/AIM_Terrestrial_Pub_4-8-26.gdb"
...
all_points_sample <- all_points |>
  ...
  dplyr::mutate(YearVisited = lubridate::year(DateVisited))|> subset(YearVisited==2025)
